...
Additionally, one common type of a joiner bolt has been identified as Signal joiner. The term Signal is used in a sense than a certain event has happened.
